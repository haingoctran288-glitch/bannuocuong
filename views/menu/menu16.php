...
.support-info, .support-form, .support-faq {
  background: white;
  border-radius: 10px;
...
<header class="header">
  ...
  <div class="support-container">
    ...
    <div class="support-info">
      ...
      <p>📞 Hotline: <b>0901 433 258</b></p>
      <p>✉️ Email: <a href="hoangphihong9a1@gmail.com">hoangphihong9a1@gmail.com</a></p>
    ...
    <div class="support-form">
      ...
      <form method="POST" action="">
        ...
        <textarea name="noidung" rows="4" placeholder="Nội dung hỗ trợ..." required></textarea>
        <button type="submit" name="guiphanhoi">GỬI NGAY</button>
      </form>
    </div>
    ...
    <div class="support-faq">
      ...
      <div class="faq-item">
        <button class="faq-question">❓ Làm sao để đặt hàng online?</button>
        <div class="faq-answer">Bạn có thể chọn sản phẩm và bấm “Đặt hàng”, sau đó điền thông tin giao hàng và xác nhận.</div>
      </div>

      <div class="faq-item">
        <button class="faq-question">❓ Tôi có thể hủy đơn hàng không?</button>
        <div class="faq-answer">Bạn có thể liên hệ hotline trong vòng 10 phút sau khi đặt để được hỗ trợ hủy đơn.</div>
      </div>

      <div class="faq-item">
        <button class="faq-question">❓ Phí giao hàng được tính như thế nào?</button>
        <div class="faq-answer">Phí giao hàng được tính dựa trên khoảng cách và sẽ hiển thị khi bạn xác nhận đơn hàng.</div>
      </div>
    </div>
  </div>
</section>
    ...
    <footer style="background-color: #007a2a; color: white; padding: 20px; font-size: 15px; line-height: 1.6;">
        <div style="display: flex; flex-wrap: wrap; gap: 20px;">
          ...
          <div style="flex: 1 1 300px; min-width: 300px;">
            ...
            <p style="margin-bottom: 10px;">
              Hotline Đặt hàng: <b>0901 433 258</b><br>
              Hotline Công ty: <b>0901 433 258</b> (Bấm phím 0: Lễ Tân | phím 1: CSKH)<br>
              Email: <a href="mailto:hoangphihong9a1@gmail.com" style="color: white;">sales@phuclong.masangroup.com</a>, <a href="mailto:info2@phuclong.masangroup.com" style="color: white;">info2@phuclong.masangroup.com</a>
            </p>
          </div>
